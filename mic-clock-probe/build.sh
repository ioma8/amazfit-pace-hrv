...
rm -rf obj dexout unsigned.apk aligned.apk
mkdir -p obj dexout
...
"$BT/apksigner" sign --ks "$HOME/.android/debug.keystore" --ks-pass pass:android --ks-key-alias androiddebugkey aligned.apk
