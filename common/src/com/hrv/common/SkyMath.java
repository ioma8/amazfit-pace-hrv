...
public final class SkyMath {
    ...
    public static final double SYNODIC = 29.530588853; // days
    public static final double NEW_MOON_EPOCH_DAYS = 10962.7597222;
    public static final double SUNSET_ZENITH = 90.833; // standard refraction + radius

    /** Equation of time (minutes) and solar declination (rad) for a UTC day. */
    public static double[] sunEq(double dayOfYear, double utcMinutes) {
    ...
    public static double[] sunPosition(long epochMs, double latDeg, double lonDeg) {
    ...
    public static long[] sunEvents(long anyMsThatDay, double latDeg, double lonDeg) {
        Calendar c = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
    ...
    public static double[] moonPhase(long epochMs) {
