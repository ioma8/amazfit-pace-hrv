...
public class MainActivity extends Activity {
    ...
    void probe(){
        ...
        try { KlvpStream.sendRequestToSensorHub('a',(short)0,(byte)0,(byte)1,(byte)0,(short)4,Klvp.PPG_ENABLE); } catch(Throwable x){Log.i(TAG,"KLVP "+x);}
        try{Thread.sleep(3000);}catch(Exception e){}
        SensorManager sm=(SensorManager)getSystemService(Context.SENSOR_SERVICE); List<Sensor> ps=sm.getSensorList(Klvp.PPG_STREAM);
        ...
        try { KlvpStream.sendRequestToSensorHub('a',(short)0,(byte)0,(byte)1,(byte)0,(short)4,Klvp.PPG_DISABLE); } catch(Throwable x){}
