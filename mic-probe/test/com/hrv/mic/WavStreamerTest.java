...
/** Host test for WavStreamer: header layout, mid-recording header refresh,
 *  and PCM round-trip. Run: javac -d /tmp/ws-test src/com/hrv/mic/WavStreamer.java
 *  test/com/hrv/mic/WavStreamerTest.java && java -cp /tmp/ws-test com.hrv.mic.WavStreamerTest */
public class WavStreamerTest {
    public static void main(String[] args) throws Exception {
        File f = File.createTempFile("wavstreamer", ".wav");
        f.deleteOnExit();
        short[] c1 = {0, 1, -1, 32767, -32768};
        short[] c2 = {100, -100, 200, -200, 300};
        short[] c3 = {32767, -32768, 0, 5, -5};

        WavStreamer w = new WavStreamer(f.getAbsolutePath(), 16000);
        w.write(c1, 5);
        w.refreshHeader();
        ...
        raf.close();
        System.out.println("WavStreamerTest PASS");
    }
